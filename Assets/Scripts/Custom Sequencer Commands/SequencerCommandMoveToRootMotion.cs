...
namespace PixelCrushers.DialogueSystem.SequencerCommands
{
    ...
    public class SequencerCommandMoveToRootMotion : SequencerCommand
    {
        ...
        public void Start()
        {
            ...
            if ((subject != null) && (target != null) && (subject != target))
            {
                ...
                subjectAnimator = subject.GetComponent<Animator>();

                // Disable root motion so the subject doesn't pop back to the original position
                subjectAnimator.applyRootMotion = false;
        ...
        public void OnDestroy()
        {
            ...
            if ((subject != null) && (target != null) && (subject != target))
            {
                ...
                subjectAnimator.applyRootMotion = true;
            }
